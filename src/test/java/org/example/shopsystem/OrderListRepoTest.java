...
class OrderListRepoTest {
    ...
    void test_addOrder() {
        ...
        List<Order> orders = repo.testInterface.orders();
        ...
        assertThat(order1).describedAs("orders().get(0)").isNotNull();
        assertThat(order1.orderNumber()).describedAs("orders().get(0).orderNumber()", orderNumber).isEqualTo(orderNumber);
    }
